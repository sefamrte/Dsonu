...
<body>
 ...
 <center>
  <a href="FOTOĞRAFLAR.php"><img width="350px" height="280" class="rounded float-start" alt="#" src="FOTOĞRAFLAR/selll.png"> 
  <h1 class="galeri"> GALERİMİZE GÖZ ATMAK İÇİN TIKLAYINIZ</h1></a>  
  <a   class="video" href="VİDEOLAR.php"> <img src="FOTOĞRAFLAR/selinnnnn.png" width="390px" height="300" class="rounded float-end" alt="#">
  <h1 class="video1">VİDEOLARIMIZI İZLEMEK İÇİN TIKLAYINIZ</h1> </a>
 </center>
